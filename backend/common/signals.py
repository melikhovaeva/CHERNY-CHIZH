...
from common.models import PuppyPhoto, Breed, PuppyDocument
...
@receiver(post_delete, sender=PuppyDocument)
def delete_puppy_document_from_storage(sender, instance, **kwargs):
    if instance.file:
        try:
