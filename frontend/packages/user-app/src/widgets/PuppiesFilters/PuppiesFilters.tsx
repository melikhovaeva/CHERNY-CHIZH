...
export function PuppiesFilters({
  ...
  const { sexOptions, potentialOptions, statusOptions } =
    usePuppyFilterOptions();
  ...
  const filters = useMemo(() => {
    ...
    return {
      ...
      potential: {
        ...
        options: createOptions(
          value.potential,
          PUPPY_FILTERS_DEFAULTS.potential,
          potentialOptions,
        ),
      },
      status: {
  ...
  const handleFilterChange =
    (key: keyof PuppyFilters) => (selectedValue: string) => {
